boolServer : (rec x. &{And: ?Bool;?Bool;!Bool;x, Or: ?Bool;?Bool;!Bool;x, Not: ?Bool;!Bool;x, End: Skip}) -> ()
boolServer c =
  match c with
    And c -> 
...
client1 : (rec x. +{And: !Bool;!Bool;?Bool;x, Or: !Bool;!Bool;?Bool;x, Not: !Bool;?Bool;x,End: Skip}) -> Bool
client1 c =
