...
-- Validation.Typing
  ...
  msg (NonEquivEnvsInUnFun _ vEnv1 vEnv2 e) sty _
    | Map.null diff =
  ...
  msg (NonEquivEnvsInBranch _ vEnv1 vEnv2 e) sty _ =
    "Couldn't match the final contexts in two distinct branches in a case or conditional expression " ++
    "\n\t       One context is " ++ style red sty vEnv1 {-(vEnv1 Map.\\ vEnv2-} ++
    "\n\t         the other is " ++ style red sty vEnv2 {-(vEnv2 Map.\\ vEnv1-} ++
