...
instance Equiv T.Type where
  ...
  -- equiv v (T.Rec _ b1) (T.Rec _ b2) = trace (show b1 ++ " " ++ show b2) equiv v b1 b2
  equiv v (T.Rec _ b1@(Bind _ _ _ t1)) (T.Rec _ b2@(Bind _ _ _ t2)) = trace ("TYPE 1: " ++ show t1 ++ " |||| TYPE 2: " ++ show t2 ++ " |||| T1 == T2: " ++ show (equiv v b1 b2)) equiv v b1 b2
...
--   equiv _ (T.LVar _) (T.LNum _) = True
--   equiv _ (T.LNum _) (T.LVar _) = True
--   equiv _ (T.LVar x1) (T.LAdd (T.LVar x2) l) = x1 == x2
--   equiv v (T.LVar x1) (T.LVar x2) = x1 == x2
