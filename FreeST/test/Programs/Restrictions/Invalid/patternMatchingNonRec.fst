type Session1 = &p{Option1: Close p+2}
type Session2 = &q{Option2: Close q+2}

client1 : Session1 ->[top,bot] dualof Session2 1->[p,bot] ()
...
client2 : Session2 ->[top,bot] dualof Session1 1->[q,bot] ()
