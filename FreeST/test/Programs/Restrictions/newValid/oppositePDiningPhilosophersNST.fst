...
fork1 : dualof Hand2 ->[top,bot] dualof Hand1 1->[1,6] ()
fork1 left right =
    let (_,right) = receive right in
    let right = send () right in
    wait right;
...
fork2 : dualof Hand4 ->[top,bot] dualof Hand3 1->[7,12] ()
fork2 left right =
    let (_,right) = receive right in
    let right = send () right in
    wait right;
...
fork3 : dualof Hand6 ->[top,bot] dualof Hand5 1->[13,18] ()
fork3 left right =
    let (_,right) = receive right in
    let right = send () right in
    wait right;
...
oppositeFork3 : dualof Hand6 ->[top,bot] dualof Hand5 1->[13,18] ()
oppositeFork3 left right = 
    let (_,left) = receive left in
    let left = send () left in
    wait left;
    let (_,right) = receive right in
