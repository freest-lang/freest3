...
writeLtGt, writeDollar, writeLtLtGtGtLtGt, writeLtLtGtLtGtGt : D;EndC -> EndC
...
mainForward : ()
mainForward =
  let (out1, in1) = new @(D;EndC) () in
  let (out2, in2) = new @(D;EndC) () in
  fork @() (\_:()1-> writeLtLtGtGtLtGt out1 |> close);
  fork @() (\_:()1-> let (c1, c2) = forwardD @EndW @EndC in1 out2 in wait c1; close c2);
  readD @EndW in2 |> wait
...
main =
  let (out1, in1) = new @(D;EndC) () in
  let (out2, in2) = new @(D;EndC) () in
  let (out3, in3) = new @(D;EndC) () in
  fork @() (\_:()1-> writeLtLtGtGtLtGt out1 |> close);
  fork @() (\_:()1-> writeLtLtGtLtGtGt out2 |> close);
  fork @() (\_:()1-> 
    let (c1, c23) = concatD @EndW @EndW @EndC in1 in2 out3 in 
    let (c2, c3 ) = c23 in 
