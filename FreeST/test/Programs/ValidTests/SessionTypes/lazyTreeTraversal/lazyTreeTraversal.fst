...
exploreTree : forall a . XploreTreeChan;a -> Tree 1-> a
exploreTree c tree =
  case tree of {
    Leaf ->
      select LeafC c,
...
exploreNode : forall a . XploreNodeChan;a -> Int 1-> Tree 1-> Tree 1-> a
exploreNode c x l r =
  match c with {
    Value c ->
...
server : forall a . dualof XploreTreeChan ;a -> Int 1-> (a, Int)
server c1 n =
  match c1 with {
    LeafC c1 ->
      (c1, n),
...
serverNode : forall a . dualof XploreNodeChan;a -> Int 1-> (a, Int)
serverNode c n =
