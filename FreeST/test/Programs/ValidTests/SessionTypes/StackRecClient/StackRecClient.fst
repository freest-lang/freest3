...
neStack : forall a . Int -> NEStack;a -> a
neStack x c =
  match c with {
...
reverseNE : forall a . Int -> dualof NEStack ; a -> dualof NEStack ; a
reverseNE n c =
  if n == 0
  then c
  else
