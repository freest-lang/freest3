...
type StdIn  : SU = *?Reader
type Reader : SL = +{ ReadBool  : &{Just: ?Bool  , Nothing: Skip}; Reader
...
type Reader : SL = +{ ReadBool  : MaybeC[Bool]  ; Reader
...
type MaybeC : SL = forall a . &{JustC: ?a  , NothingC: Skip}
-}
