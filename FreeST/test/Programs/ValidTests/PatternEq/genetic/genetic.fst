...
crossoverBoth_ ind0 ind1 counter 0 = (ind0 * counter, ind1 * counter)
...
generatePopulation seed 0    = (seed, NilPop)
...
geneticAlg_ seed 0 pop = (seed,pop)
...
initIslands_ channels seed 0 popSize nIterI nIterG =
...
masterLoop channels 0      = channels
