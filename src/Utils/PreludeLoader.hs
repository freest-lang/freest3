...
typeList = [ (mkPVarNonBindable "(+)",  binInt)
           , (mkPVarNonBindable "(-)", binInt)
           , (mkPVarNonBindable "(/)", binInt)
           , (mkPVarNonBindable "(*)", binInt)
           , (mkPVarNonBindable "mod", binInt)
           , (mkPVarNonBindable "rem", binInt)
           , (mkPVarNonBindable "div", binInt)
           , (mkPVarNonBindable "negate", unIntInt)
           , (mkPVarNonBindable "not", unBoolBool)
           , (mkPVarNonBindable "(&&)", binBool)
           , (mkPVarNonBindable "(||)", binBool)
           , (mkPVarNonBindable "(==)", relationalOps)
           , (mkPVarNonBindable "(<)", relationalOps)
           , (mkPVarNonBindable "(>)", relationalOps)
           , (mkPVarNonBindable "(<=)", relationalOps)
           , (mkPVarNonBindable "(>=)", relationalOps)
           , (mkPVarNonBindable "id", TypeScheme defaultPos [TBindK defaultPos "a" (Kind defaultPos Session Un)] (Fun defaultPos Un (TypeVar defaultPos "a") (TypeVar defaultPos "a")))
           ]
