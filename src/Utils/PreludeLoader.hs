...
typeList = [ (mkNonBindablePVar "(+)",  binInt)
           , (mkNonBindablePVar "(-)", binInt)
           , (mkNonBindablePVar "(/)", binInt)
           , (mkNonBindablePVar "(*)", binInt)
           , (mkNonBindablePVar "mod", binInt)
           , (mkNonBindablePVar "rem", binInt)
           , (mkNonBindablePVar "div", binInt)
           , (mkNonBindablePVar "negate", unIntInt)
           , (mkNonBindablePVar "not", unBoolBool)
           , (mkNonBindablePVar "(&&)", binBool)
           , (mkNonBindablePVar "(||)", binBool)
