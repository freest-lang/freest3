...
Given a context-free session type $S$, a set of productions is
...
% recursive function presented in Listing~\ref{lst:toGrammar}. 
...
\ell_k$. \vv{this transition relation is not defined}
%
