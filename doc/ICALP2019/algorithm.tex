...
\label{ex:productions}
	...
	\end{array}\]
	$\mathsf{toGrammar}$ applied to $S$ and $T$ leads to the following productions:\\
...
\label{ex:prune}
	...
	$X_4$ in the last production is unreachable. Hence, by pruning the productions 
	for $X_S$ we get:\\
...
\label{fig:expansionTree}
	\includegraphics[width=8.5cm]{img/expansionTree}
