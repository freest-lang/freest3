\section{An algorithm to decide type bisimulation}
\label{sec:algorithm}
...
in productions. The last stage explores an expansion tree, alternating
...
$X \LTSderives a\vec Z \in\productions$. \vv{reference here} The
...
\subsection{Checking bisimulation}
