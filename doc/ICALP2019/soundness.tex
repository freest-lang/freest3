...
\begin{proof}
  ...
  \begin{gather*}
    ...
    %
    \text{ when } \vec Y_i,\mathcal P_i = \toGrammarf{S_i}, i \in I
    \\
    ...
    %
    \text{ when } \vec X_i,\mathcal P_i = \toGrammarf{S_i}, i = 1,2
    \\
    (S'_1;S_2, (\vec Y, \mathcal P_1 \cup \mathcal P_2))
    %
    \text{ and, in addition, } S_1 \LTSderives S_1' 
    \text{ and } \vec X_1\vec X_2 \LTSderivesP \vec Y
    \\
    (S_2', (\vec Y, \mathcal P_1 \cup \mathcal P_2))
    %
    ...
    \\
    (\mu X.S, (X, \{X \LTSderivesP[a] \vec Z\vec Y\}_{i\in I} \cup \mathcal P))
    %
    \text{ when not }  \isCheckedf \mu X.S
    \text{ and } Y\vec Y,\mathcal P = \toGrammarf{S}
    \\
    (T, (\vec Z\vec Y, \{X \LTSderivesP \vec Z\vec Y\}_{i\in I} \cup \mathcal P))
    %
