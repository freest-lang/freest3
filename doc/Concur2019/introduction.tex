...
readily extracted, except the one by Czerwinski and Lasota where a
...
EXPTIME-hard~\cite{kiefer2013bpa}, whereas Jan\v car have provided a
...
%
The source code for the Haskell implementation is available at
