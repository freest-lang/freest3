...
\begin{lemma}
  ...
  For any type $S$, if not $\isCheckedf S$ and
  $(\mu X.S, (X, \{X \rightarrow a_j \vec {Z_j}\vec Y\}_{j\in J} \cup
  P))\in \mathcal{R}$ with
  $\{Y \rightarrow a_j \vec {Z_j}\}_{j\in J}\subseteq P$, then
  $(\Unravel(\mu X.S), (X, \{X \rightarrow a_j \vec {Z_j}\vec
  Y\}_{j\in J} \cup P)) \in \mathcal{R}$.
\end{lemma}
