...
% A primitiva \lstinline|choice| é implementada com recurso a canais síncronos. 
% tryReadChan :: Chan a -> IO (TryResult a)
% evita situações de impasse uma vez que é uma alternativa não bloqueante que tenta ler um valor de um canal e sucede se um ``escritor'' do canal estiver pronto para sincronizar a comunicação.
