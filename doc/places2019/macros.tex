...
\newcommand{\algtypeout}[4][\kindEnv;\varEnv]{{#1} \Alg {#2}
  \shortrightarrow {#3};{#4}}
\newcommand{\algtypein}[4][\kindEnv;\varEnv]{{#1} \Alg {#2}\colon {#3}
  \shortrightarrow {#4}}
\newcommand{\ctxequiv}[3][\kindEnv]{{#1} \vdash \Equiv{#2}{#3}}
\newcommand{\typeequiv}[3][\kindEnv]{{#1} \vdash \Equiv{#2}{#3}}
\newcommand{\isLin}[2][\kindEnv]{{#1} \vdash {#2}\colon\link}
\newcommand{\isUn}[2][\kindEnv]{{#1} \vdash {#2}\colon\unk}
