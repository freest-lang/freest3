...
\node{\lstinline|1|}
	child { node {\lstinline|2|}
		child [level 3/.append style={sibling distance=1cm}]{ node {\lstinline|8|}
		...
		child { node  {\lstinline|3|}
			...
			child { node  {\lstinline|4|}
				child { node {\lstinline|Leaf|}}
				child { node {\lstinline|Leaf|}} }}}
	child[level 2/.append style={sibling distance=1cm}] { node {\lstinline|6|}
		child { node {\lstinline|Leaf|}}
		child[level 3/.append style={sibling distance=1cm}] { node  {\lstinline|7|}
			child { node {\lstinline|Leaf|}}
			child { node {\lstinline|Leaf|}}}}
;
\end{tikzpicture} 
	...
	child { node {\lstinline|22|}
		...
		child { node  {\lstinline|12|}
			...
			child { node  {\lstinline|4|}
				child { node {\lstinline|Leaf|}}
				child { node {\lstinline|Leaf|}} }}}
	child[level 2/.append style={sibling distance=1cm}] { node {\lstinline|13|}
		child { node {\lstinline|Leaf|}}
		child[level 3/.append style={sibling distance=1cm}] { node  {\lstinline|7|}
			child { node {\lstinline|Leaf|}}
			child { node {\lstinline|Leaf|}}}}
