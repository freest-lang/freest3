...
\newcommand{\msg}[2]{#1 #2}
\newcommand{\msgOutT}[1]{\msg \outView #1}
\newcommand{\msgInT}[1]{\msg \inView #1}

\newcommand{\recT}[2]{\mu #1 . #2}
\newcommand{\semiT}[2]{#1 ; #2}

\newcommand{\choiceT}[2]{#1\{#2\}}
\newcommand{\choiceExtT}[1]{\choiceT \external {#1}}
\newcommand{\choiceIntT}[1]{\choiceT \internal {#1}}
