...
\newcommand\kDualof{\keyword{dualof}}
\newcommand\kSkip{\keyword{skip}}

% Types
\newcommand{\tSkip}{\kSkip}
...
\newcommand{\tData}[1]{[{#1}]}
\newcommand\tFun[3][m]{{#2}\rightarrow_{#1}{#3}}
...
\newcommand{\algkindout}[3][\kindEnv]{{#1} \Alg {#2} \synthetise{ #3}}
\newcommand{\algkindin}[3][\kindEnv]{{#1} \Alg {#2} \checkagainst {#3}}
\newcommand{\isSubkind}[2]{{#1} < {#2}}
\newcommand{\algtypeout}[4][\kindEnv;\varEnv]{{#1} \Alg {#2} \synthetise {#3};{#4}}
%\newcommand{\algtypein}[4][\kindEnv;\varEnv]{{#1} \Alg {#2}\colon {#3}\synthetise {#4}}
\newcommand{\algtypein}[4][\kindEnv;\varEnv]{{#1} \Alg {#2}\checkagainst {#3}; {#4}}
\newcommand{\ctxequiv}[3][\kindEnv]{{#1} \vdash \Equiv{#2}{#3}}
\newcommand{\typeequiv}[3][\kindEnv]{{#1} \vdash \Equiv{#2}{#3}}
\newcommand{\isLin}[2][\kindEnv]{\isType[#1]{#2}\link}
\newcommand{\isUn}[2][\kindEnv]{\isType[#1]{#2}\unk}
\newcommand{\isContractive}[2][\kindEnv]{{#1} \vdash_{\textsf c} {#2}}
