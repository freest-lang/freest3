...
\newcommand{\am}[1]{\todo{AM}{#1}}


% Relations, predicates and operators
%\newcommand\PAR{|}
%\newcommand{\isType}[2][\Delta]{{#1} \vdash {#2}\;\typek}
\newcommand{\isNotType}[2][\Delta]{{#1} \not\vdash {#2}}
\newcommand{\isType}[2][\Delta]{{#1} \vdash {#2}}
...
\newcommand\bisim{\sim_\types}
\newcommand\bisimP{\sim_\productions}
\newcommand\Power{\wp}
\newcommand{\Silent}{\tau}
\newcommand{\Wderives}[1][{}]{\stackrel{#1}{\Longrightarrow}}
\newcommand{\LTSderives}[1][a]{\stackrel{#1}{\longrightarrow}_\types}
\newcommand{\LTSderivesP}[1][a]{\stackrel{#1}{\longrightarrow}_\productions}
...
\newcommand{\grm}{\mathsf{grm}} % shortened from "toGrammar"
\newcommand{\word}{\mathsf{word}}
\newcommand{\Bisim}{\mathsf{bisimG}}
\newcommand{\BisimT}{\mathsf{bisimT}}
...
\newcommand\TypeEquiv{\sim_\types}
\newcommand\ProdEquiv{\sim_\productions}
\newcommand\BridgeEquiv{\sim_\mathcal{R}}
...
\newcommand\LTSTypes{\mathsf{LTS}_{\mathcal{T}}}
\newcommand\LTSProds{\mathsf{LTS}_{\mathcal{P}}}
...
\newcommand{\Empty}{\varepsilon} % the empty word
...
\newcommand{\casen}[2]{\casek\,{#1}\,\ofk\,{#2}}
...
% New environments
%\newenvironment{itemizeproof}{\begin{proof}}{\vspace{-4.85ex}\end{proof}}
...
\newcommand{\textlstinline}[1]{\text{\upshape{\lstinline|#1|}}}
% The k is for keyword 
\newcommand{\toGrammark}{\textlstinline{toGrammar}}
\newcommand{\transStatek}{\textlstinline{TransState}}
\newcommand{\evalStatek}{\textlstinline{evalState}}
\newcommand{\bisimk}{\textlstinline{bisimilar}}
\newcommand{\isCheckedk}{\textlstinline{terminated}}
% The f is for function
\newcommand{\toGrammarf}[1]{\toGrammark\:{#1}}
\newcommand{\bisimf}[2]{\bisimk{#1}\:{#2}}
\newcommand{\isCheckedf}[1]{\isCheckedk\:{#1}}
...
%fixed point
\newcommand{\leqSets}{\sqsubseteq}
\newcommand{\leqNAS}{\preceq}
