...
Lemma~\ref{lemma:terminated-togrammar} and since $T_i'$ is
non-terminated by hypothesis.  The function $\grm$ terminates on all
inputs (because recursion is always on subterms) and adds a finite
