...
returns $\True$.
In the other cases, it computes the child of the next node $n$ in the queue
and makes a recursive call on the simplified nodes derived from it.
%
\begin{align*}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=7.5cm]{img/expansion_tree_example}  
