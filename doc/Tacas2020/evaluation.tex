...
The tests produced by this method, although small and lacking diversity
...
\texttt{fpco/stack-build}. We also implemented the optimisations proposed
in Section~\ref{sec:optimisations}.
...
they were introduced in Section~\ref{sec:optimisations}.
We ran the tests with a timeout of 30 minutes. Table~\ref{table:timeouts} 
