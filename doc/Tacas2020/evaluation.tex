...
\texttt{fpco/stack-build}. Evaluation was conducted on a machine with an Intel Xeon X5670 at 2.93GHz and 24 GB of RAM.


%\begin{figure}[h]
	\includegraphics[height=6cm]{img/distribution_boxplot}	\hspace*{2mm}
	\includegraphics[height=6cm]{img/nodes_time_B0}
	\caption{Distribution of execution time of the bisimilar function (on the left) and distribution of execution time per total number of nodes of both types (on the right).}
	\label{fig:results}
\end{figure}
