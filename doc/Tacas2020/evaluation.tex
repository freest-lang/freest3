...
\begin{figure}[h!]
    \centering
    \subfloat[Distribution of execution time]{\includegraphics[height=6cm]{img/distribution_boxplot}}%
    \subfloat[Execution time per number of nodes]{\includegraphics[height=6cm]{img/nodes_time_B0}}%
