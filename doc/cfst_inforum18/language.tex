...
\item Dado um contexto, uma expressão e um tipo verificar o tipo da expressão de encontro ao tipo esperado através da relação de equivalência ($\thicksim$):%, neste caso verifica se U e T são equivalentes ($\Equiv{U}{T}$):
